...
namespace Service_Center_Backend.Services
{
	public class AccountService : IAccountService
	{
		...
		public AccountService(ServiceCenterContext context)
		{
			_context = context;
		}
		...
		{
			var account = await _context.Accounts.Where(a => a.Login.ToLower().Equals(login.ToLower())).FirstOrDefaultAsync();
			if (account is null)
			{
